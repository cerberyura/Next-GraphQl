...
export enum CommentStatusEnum {
  /** Comments with the Схвалено status */
  Approve = 'APPROVE',
  /** Comments with the Не схвалено status */
  Hold = 'HOLD',
  /** Comments with the Спам status */
  Spam = 'SPAM',
  /** Comments with the В кошику status */
  Trash = 'TRASH'
}
...
export type DiscussionSettings = {
  ...
  /** Дозволити залишати коментарі до нових записів. */
  defaultCommentStatus?: Maybe<Scalars['String']['output']>;
  /** Дозволити посилання оповіщення з інших блогів (сповіщення і зворотні посилання) на нові статті. */
...
export type GeneralSettings = {
  ...
  /** Гасло сайту. */
  description?: Maybe<Scalars['String']['output']>;
  /** Ця адреса використовується в цілях адміністрування. Наприклад, для сповіщень про нових користувачів. */
  email?: Maybe<Scalars['String']['output']>;
  ...
  /** Місто в тій же часовій зоні що і у вас. */
...
export type ReadingSettings = {
  ...
  /** Максимум сторінок блогу для показу. */
...
export type UpdateSettingsInput = {
  ...
  /** Категорія для записів за замовчуванням. */
  writingSettingsDefaultCategory?: InputMaybe<Scalars['Int']['input']>;
  /** Формат записів за замовчуванням. */
  writingSettingsDefaultPostFormat?: InputMaybe<Scalars['String']['input']>;
  /** Перетворювати смайлики на зразок :-) і :-P в картинки при показі. */
...
export type GetPostsEdgesQuery = { __typename?: 'RootQuery', posts?: { __typename?: 'RootQueryToPostConnection', edges: Array<{ __typename?: 'RootQueryToPostConnectionEdge', node: { __typename?: 'Post', id: string, title?: string | null, date?: string | null, author?: { __typename?: 'NodeWithAuthorToUserConnectionEdge', node: { __typename?: 'User', name?: string | null, email?: string | null } } | null } }> } | null };
